...
if exist "Migrations\LogApp" rmdir /s /q "Migrations\LogApp"
...
dotnet ef migrations add InitialCreate --context DbLogAppContext --output-dir Migrations\LogApp --project . --startup-project .
