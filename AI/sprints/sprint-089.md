...
## 태스크
- [ ] .github/scripts/generate_architecture_docs.py 작성 (파싱 + overview.md 재생성)
- [ ] docs.yml에 "Generate architecture docs" 스텝 추가
- [ ] overview.md를 스크립트로 1회 재생성 (Game.Lobby/Gomoku 반영)
- [ ] sequences.md Section 3 매칭 시퀀스 현행화 수동 갱신
