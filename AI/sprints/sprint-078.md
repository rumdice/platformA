...
## 태스크
- [x] 대기열 만료(TTL 초과) 케이스 테스트 추가 (GetStatus_*Rank_Returns*msDelay)
- [x] 중복 티켓 요청 차단 테스트 추가 (LeaveQueue_ActiveTicket_Returns400)
- [x] 대기열 최대 사이즈 초과 테스트 추가 (EnterQueue_QueueFull_Returns400)
- [x] 티켓 없는 상태에서 대기열 상태 조회 테스트 추가 (GetStatus_HighRank/MidRank/LowRank)
- [x] 비정상 토큰/입력값 경계 케이스 테스트 추가 (InvalidToken 2개, RateLimitExceeded 1개)
