...
`AI/sprints/` 디렉터리에서 현재 브랜치 또는 최신 sprint-NNN.md를 읽어 상태를 분석하고 보고한다.
...
없으면 가장 최근 sprint-NNN.md를 읽는다:
```bash
ls AI/sprints/sprint-*.md | sort | tail -1
```
